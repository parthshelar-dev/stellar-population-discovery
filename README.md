...
**[🌟 Explore the Interactive Dashboard](https://stellar-population-discovery.streamlit.app/dashboard)**
...
│   ├── app images/
│   │   ├── Home Page.png
│   │   ├── 3D Cluster Visualization.png
│   │   ├── 2D Cluster Visualization.png
│   │   ├── Algorithm Performance Comparison.png
│   │   ├── Cluster Statistics.png
...
### Home Page
![Home Page](images/app%20images/Home%20Page.png)

### 3D Cluster Visualization
![3D Visualization](images/app%20images/3D%20Cluster%20Visualization.png)

### 2D Cluster Visualization
![2D Visualization](images/app%20images/2D%20Cluster%20Visualization.png)

### Algorithm Performance Comparison
![Comparison](images/app%20images/Algorithm%20Performance%20Comparison.png)

### Cluster Statistics
![Statistics](images/app%20images/Cluster%20Statistics.png)

### Dataset Overview
![Dataset](images/app%20images/Dataset%20Overview.png)
...
- Applied on 10,000-star sample due to O(n²) complexity — Ward linkage, 3 clusters
- Applied on all 4 PCA components
...
> **Evaluation Note:** K-Means and DBSCAN were trained on the full dataset (~50,000 stars), whereas Agglomerative Hierarchical Clustering was trained on a representative 10,000-star sample due to computational constraints. Silhouette scores should be interpreted as performance indicators within their respective experimental setups.
...
This project demonstrates that unsupervised machine learning can successfully identify meaningful stellar populations from Gaia DR3 data. KMeans achieved the highest silhouette score, while DBSCAN provided the additional capability of detecting anomalous stars. Agglomerative Hierarchical Clustering validated the underlying cluster structure on a representative 10,000-star sample, demonstrating the practical trade-off between computational efficiency and scalability. Overall, stellar populations exhibit separable structures in PCA-transformed feature space and can be effectively analyzed using unsupervised clustering techniques.
...
- [ ] Cluster-wise HR Diagram analysis for KMeans, DBSCAN, and Hierarchical Clustering
